  ...
  template: `
    <div class="flex h-full min-w-0 flex-1 flex-col gap-6 p-4">
      <header class="space-y-1">
        <p class="text-secondary-600 dark:text-dark-secondary-400 text-xs font-semibold uppercase tracking-[0.24em]">Expenses</p>
      </header>
        ...
        <nav class="border-secondary-200 dark:border-dark-divider bg-white dark:bg-dark-primary-850 inline-flex max-w-full flex-wrap gap-0.5 rounded-full border p-0.5">
          @for (section of sections; track section.route) {
            <a
              ...
              class="text-secondary-600 dark:text-dark-secondary-400 hover:text-secondary-800 dark:hover:text-dark-secondary-100 rounded-full px-3 py-1.5 text-xs font-semibold transition-colors [&.active]:bg-secondary-200 [&.active]:text-secondary-900 dark:[&.active]:bg-dark-primary-700 dark:[&.active]:text-dark-secondary-50"
